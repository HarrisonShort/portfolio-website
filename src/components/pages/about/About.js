            ...
            <section id="about-section">
                <div className="about-container">
                    ...
                    <div className="about-container-right">
                        <img src="/images/harrison_okunoshima.jpg" alt="Harrison Okunoshima" className="about-image" />
                    </div>
                </div>
                <div className="about-container">
                    <div className="about-container-left">
                    ...
                    <div className="about-container-right">
                        <img src="/favicon.png" alt="RedChung" className="about-image" />
                    </div>
                </div>
                <div className="about-container">
                    <div className="about-container-left">
                    ...
                    <div className="about-container-right">
                        <img src="/images/district.jpg" alt="district" className="about-image" />
                    </div>
                </div>
                <div className="about-container">
                    <div className="about-container-left">
                    ...
                    <div className="about-container-right">
                        <img src="/images/ardacious.png" alt="ardacious" className="about-image" />
                    </div>
                </div>
            </section>
